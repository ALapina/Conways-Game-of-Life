  ...
  return (
    <div className='flex items-center p-4'>
      ...
      <Root
        ...
        id='mode-switcher'
        className='w-11 h-6 bg-blackA9 rounded-full relative shadow-[0_2px_10px] shadow-blackA7 focus:shadow-[0_0_0_2px] focus:shadow-black data-[state=checked]:bg-black outline-none cursor-default'
      >
